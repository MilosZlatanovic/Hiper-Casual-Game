...
public class HudMenu : MonoBehaviour
{
    ...
    public void SetSpriteElements(int indexElement)
    {
        ...
        /* foreach (Sprite item in spriteElements )
         {
          //  bonusPoints.Add(curenntElement)
    ...
    private void FifeSame()
    {
      ...
      bonusCombination[1] == bonusCombination[1] && bonusCombination[1] == bonusCombination[2] && bonusCombination[1] == bonusCombination[3] && bonusCombination[1] == bonusCombination[4] && bonusCombination[1] == bonusCombination[4])
        {
    ...
    private void FullHouse()
    {
        if (isFullHouse)
        {
            ...
            if (bonusCombination[0] == bonusCombination[1] && bonusCombination[2] == bonusCombination[3] && bonusCombination[2] == bonusCombination[4] ||
